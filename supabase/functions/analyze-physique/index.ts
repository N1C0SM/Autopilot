    ...
    const { text } = await generateText({
      ...
      system:
        [
          ...
          'headline_diagnosis: UNA frase contundente sobre lo que realmente se ve. bottleneck: el ÚNICO factor que más le frena, indicando de qué vista viene. improvements: 3-5 puntos priorizados (Alta/Media/Baja), solo sobre grupos visibles. summary: 2-3 frases; si falta una vista, dilo explícitamente ("Vista trasera no disponible: no puedo valorar espalda ni glúteos" o "Vista frontal no disponible: no puedo valorar pecho ni abdomen").',
          ...
          'muscle_breakdown: 4-8 grupos, SOLO los visibles en las vistas recibidas — frontal: "Pecho", "Deltoides", "Brazos", "Core/abdomen", "Cuádriceps"; trasera: "Espalda alta", "Dorsales", "Deltoides posterior", "Cadena posterior (glúteo+isquio)", "Gemelos". Cada uno con score 0-10 y verdict de 1 frase específica ("Deltoide medio plano, falta de redondeo lateral evidente desde la frontal").',
